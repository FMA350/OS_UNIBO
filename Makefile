...
CFILES   = init.c p2test.c scheduler.c mikabooq.c interrupts.c ssi.c syscall.c trap.c syslib.c \
			create_process.c create_thread.c do_io.c getcputime.c get_errno.c get_id.c setmgr.c \
			terminate_process.c terminate_thread.c wait_for_clock.c debug_tests.c pseudoclock.c time.c
